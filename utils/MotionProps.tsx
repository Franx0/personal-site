...
const pageVariants = {
  ...
  cookiesEasing: {
    initial: { width: "100%", position: "absolute", left: 0, bottom: 0, x: -5000, transition: easingInOutTransition() },
    exit: { width: "100%", position: "absolute", left: 0, bottom: 0, x: 5000, transition: easingInOutTransition() },
    enter: { width: "100%", position: "absolute", left: 0, bottom: 0, x: 0, transition: easingInOutTransition() }
  },
  scalingY: {
    initial: { y: -200 },
    exit: { y: -200 },
