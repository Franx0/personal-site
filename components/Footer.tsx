  ...
  return (
    <footer>
      <div className="w-full px-4">
        <div className="md:flex-row flex-col -mx-4 md:py-4">
          <div className="md:flex px-4">
            <div className="flex justify-center md:justify-start m-3 min-w-min">
              <p className="hidden md:flex md:align-middle md:m-auto md:ml-0 md:mr-0">Contact me on: </p>
              <a href={`${process.env.NEXT_PUBLIC_GITHUB_ACCOUNT}`} style={{paddingLeft: "0.05rem", paddingTop: "0.04rem"}} className="w-8 h-8 text-accent hover:text-white border border-2 border-gray-400 rounded-full text-center ml-2 text-gray-600 hover:bg-black hover:border-black">
              ...
              <a href={`${process.env.NEXT_PUBLIC_GMAIL_ACCOUNT}`} className="w-8 h-8 text-accent hover:text-white border border-2 border-gray-400 rounded-full text-center px-1.5 py-1.5 ml-2 text-gray-600 hover:bg-red-600 hover:border-red-600">
                <Gmail width={5.5} height={5.5} />
              </a>
            </div>
            <p className="md:flex md:align-middle md:m-auto md:mr-0 text-center justify-center md:justify-end">Designed and built by Fran Moya</p>
          </div>
        </div>
      </div>
    </footer>
